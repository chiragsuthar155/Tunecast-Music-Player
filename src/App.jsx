...
const App = () => {
  ...
  return (
    <div id="top" className="relative flex">
      ...
      {activeSong?.title && (
        <div className="absolute h-48 md:h-36 md:pt-5 bottom-8 md:bottom-12 left-0 right-0 flex animate-slideup bg-orange-500 backdrop-blur-lg rounded-t-3xl z-10">
          <MusicPlayer />
        </div>
      )}
    </div>
